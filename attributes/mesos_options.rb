default['mesos']['options'] = {
  'master' => {
    'acls' => {
      'version' => ['0.21.0', '0.21.1', '0.22.0', '0.22.1', '0.23.0', '0.23.1', '0.24.1'],
      'default' => '',
      'flag' => false,
      'deprecated' => false
    },
    ...
    'authenticators' => {
      'version' => ['0.22.0', '0.22.1', '0.23.0', '0.23.1', '0.24.1'],
      'default' => '',
      'flag' => false,
      'deprecated' => false
    },
  ...
  'slave' => {
    ...
    'docker_sandbox_directory' => {
      'version' => ['0.21.0', '0.21.1', '0.22.0', '0.22.1', '0.23.1'],
